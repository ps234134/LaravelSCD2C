                    ...
                    <form method="POST" action="{{ route('songs.update', $songs->id) }}">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="text" name="title" placeholder="100"
                                value="{{ old('song', $songs->title) }}">
                            @error('song')
                                        ...
                                        <tbody class="bg-white">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                                                        <form action="{{ route('songs.detach', ['song' => $songs, 'album' => $album]) }}" method="POST">
                                                            @csrf
                                    ...
                                    <tbody class="bg-white">
                                            ...
                                            @foreach ($albums as $album)
                                                <tr>
                                                    ...
                                                    <form action="{{ route('songs.attach',  ['song' => $songs, 'album' => $album]) }}" method="POST">
                                                        @csrf
                                                        <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                                                            <button type="submit" class="flex items-center px-8">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
