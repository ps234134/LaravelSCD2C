            ...
            <div class="w-full px-16 py-20 mt-6 overflow-hidden bg-white rounded-lg lg:max-w-4xl">
                ...
                <div class="mb-4">
                    <h1 class="font-serif text-3xl font-bold">Create Song</h1>
                        ...
                        <form method="POST" action="{{ route('songs.store') }}" class="flex flex-col items-center sm:justify-center sm:pt-0">
                        @csrf
                                            ...
                                            <tr>
                                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                    <div class="flex items-center">
                                                            <option value="{{ $song['id'] }}">{{ $song['title'] }} by {{ $song['singer'] }}</option>
