    ...
    <div class="font-sans antialiased">
        <div class="flex flex-col items-center min-h-screen pt-6 bg-gray-100 sm:justify-center sm:pt-0">
            ...
            <div class="w-full px-16 py-20 mt-6 overflow-hidden bg-white rounded-lg lg:max-w-4xl">
                ...
                <div class="mb-4">
                    <h1 class="font-serif text-3xl font-bold">Update Album</h1>
                </div>
                ...
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form method="POST" action="{{ route('albums.update', $albums->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <input
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                type="text" name="year" placeholder="100" pattern="^\d{4}$" value="{{ old('album', $albums->year) }}">
                            @error('year')
                                <span class="text-red-600 text-sm">
                                    {{ $message }}
                                </span>
                          ...
                          <div class="mt-4">
                            ...
                            <input
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                type="text" name="times_sold" placeholder="100" value="{{ old('album', $albums->times_sold) }}">
                            @error('times_sold')
                                <span class="text-red-600 text-sm">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="w-full px-0 py-20 mt-6 overflow-hidden bg-white rounded-lg lg:max-w-6xl">
                            <div class="grid grid-cols-2 ">
                                <div class="inline-flex flex-col px-6">
                                    <h1 class="font-bold font-serif text-2xl inline-flex justify-center " >Songs in album</h1>
                                    <div>
                                            ...
                                            <tbody class="bg-white">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                                                            <form action="{{ route('albums.detach', [$albums, $song]) }}" method="POST">
                                                                @csrf
                                        ...
                                        <tbody class="bg-white">
                                                ...
                                                @foreach ($songs as $song)
                                                    <tr>
                                                        ...
                                                        <form action="{{ route('albums.attach', [$albums, $song]) }}" method="POST">
                                                            @csrf
                                                            <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                                                                <button type="submit" class="flex items-center px-8">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
