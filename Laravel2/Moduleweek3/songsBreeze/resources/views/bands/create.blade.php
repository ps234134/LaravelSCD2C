                ...
                <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                    <form method="POST" action="{{ route('bands.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <input
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                type="text" name="genre" placeholder="100">
                            @error('genre')
                                <span class="text-red-600 text-sm">
                                    {{ $message }}
                                </span>
                         ...
                         <div class="mt-4">
                            ...
                            <input
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                type="text" name="founded" placeholder="100" pattern="^\d{4}$">
                            @error('founded')
                                <span class="text-red-600 text-sm">
                                    {{ $message }}
                                </span>
                        ...
                        <!-- founded -->
                        <div class="mt-4">
                            <label class="block text-sm font-medium text-gray-700" for="active_til">
                                Active till
                            </label>
                            <input
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                type="text" name="active_till" placeholder="100" pattern="^\d{4}$">
                            @error('active_till')
                                <span class="text-red-600 text-sm">
                                    {{ $message }}
                                </span>
